	...
	export default{
		data(){
			return{
				...
				buyNum:1,
				dataImg:[
					"https://www.taokubuy.com/data/upload/shop/store/goods/74/74_06281628477826946_1280.jpg",
					"https://www.taokubuy.com/data/upload/shop/store/goods/74/74_06281628975290376_1280.jpg",
					"https://www.taokubuy.com/data/upload/shop/store/goods/74/74_06281628994072575_1280.jpg",
					"https://www.taokubuy.com/data/upload/shop/store/goods/74/74_06281629013647129_1280.jpg"
		...
		methods:{
			...
			addCart(){
				this.$toast('已加入购物车');
				this.show=false;
				this.$store.commit("addGood",{choose:true,id:this.datas.goods_info.gc_id_1,name:this.datas.goods_info.goods_name,num: this.buyNum,price:this.datas.goods_info.goods_price,img:this.datas.spec_image[0]} )
			},
			onClickIcon() {
			  this.$toast('点击了客服图标');
			},
