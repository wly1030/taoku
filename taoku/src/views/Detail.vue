	...
	<div class="big">
		<div v-show="!flag">
			<div class="goUpImg" @click="goUp" >
				...
				<!-- <van-icon name="arrow-left" size="25" color="rgb(238,94,108)" /> -->
			</div>
			<div class="imgTwo">
				<!-- 三个点点标志 -->
			...
			<van-popup v-model="show" position="bottom" :style="{ height: '80%' }">
				<div style="display: flex;">
					...
					<div style="width: 250px; text-align: left; margin: 0; position: absolute; top: 20px; right: 20px;font-size: 12px;">
						<div>
