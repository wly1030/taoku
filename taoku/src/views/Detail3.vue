			...
			<van-popup v-model="show" position="bottom" :style="{ height: '80%' }">
				<div style="display: flex;">
					<div style="position: absolute; left: 20px;top: 20px;">
						<img src="https://www.taokubuy.com/data/upload/shop/store/goods/78/78_06190905841563488_60.jpg" alt="">
					</div>
	...
	export default{
		data(){
			return{
				...
				buyNum:1,
				dataImg:[
					"https://www.taokubuy.com/data/upload/shop/store/goods/78/78_06190905841563488_1280.jpg",
					"https://www.taokubuy.com/data/upload/shop/store/goods/78/78_06190905978572848_1280.jpg",
					"https://www.taokubuy.com/data/upload/shop/store/goods/78/78_06190905980163009_1280.jpg",
					"https://www.taokubuy.com/data/upload/shop/store/goods/78/78_06190905970220308_1280.jpg",
					"https://www.taokubuy.com/data/upload/shop/store/goods/78/78_06190905972026128_1280.jpg"
				],
				areaList:
				{
				  province_list: {
		...
		methods:{
			...
			addCart(){
				this.$toast('已加入购物车');
				this.show=false;
				this.$store.commit("addGood",{id:this.datas.goods_info.gc_id_1,name:this.datas.goods_info.goods_name,num: this.buyNum,price:this.datas.goods_info.goods_price,img:"https://www.taokubuy.com/data/upload/shop/store/goods/78/78_06190905841563488_60.jpg"} )
			},
			onClickIcon() {
			  this.$toast('点击了客服图标');
			},
